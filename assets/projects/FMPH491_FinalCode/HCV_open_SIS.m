...
[T,Y] = ode45(@HCV, tspan, initconditions); %Y is ODE output as a matrix with solutions at each time stamp, T is output timepoint vector of 121 time stamps. @sir is function of the ODES.
